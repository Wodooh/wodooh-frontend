  ...
  return (
    <div className="nx-shell">
      <aside className="nx-sidebar">
        <Link href="/student/dashboard" className="nx-sidebar-brand" style={{ textDecoration: "none" }}>
          <div className="nx-sidebar-logo">W</div>
          <div className="nx-sidebar-brand-text">
            WODOOH<span className="nx-sidebar-brand-sub">Student</span>
          </div>
        </Link>

        <div className="nx-sidebar-section-label">Workspace</div>
        <nav className="nx-sidebar-nav" role="navigation" aria-label="Student Portal Navigation">
          {NAV.map(item => {
